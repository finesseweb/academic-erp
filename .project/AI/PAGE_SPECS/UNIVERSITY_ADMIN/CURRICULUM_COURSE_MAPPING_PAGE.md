...
## Credit treatment
Credit Treatment is inherited from the parent Curriculum Slot and is not editable per mapped Course / Paper. This prevents conflicting countability rules inside one Slot.
