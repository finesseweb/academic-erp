...
University permission management accepts only roles with `created_by_scope_type = UNIVERSITY`. A College-created role cannot be opened or mutated through a direct University role-permission URL.
