...
## Course Offering audit events (2026-09-20)
- `COURSE_OFFERING_CREATED`
- `COURSE_OFFERING_ACTIVATED`
- `COURSE_OFFERING_DEACTIVATED`
- `TEST_COURSE_OFFERING_CLEANED` (Test Data Cleanup)

Runtime Course Offering events use resource type `CourseOffering` and College scope inherited through Batch -> Program Offering.
- Faculty Allocation: `FACULTY_ALLOCATION_CREATED`, `FACULTY_ALLOCATION_UPDATED`, `FACULTY_ALLOCATION_ACTIVATED`, `FACULTY_ALLOCATION_DEACTIVATED`, and maintenance-only `TEST_FACULTY_ALLOCATION_CLEANED`.
- Course Delivery scheduling: `ROOM_CREATED`, `ROOM_UPDATED`, `TIMETABLE_ENTRY_CREATED`, `TIMETABLE_ENTRY_UPDATED`, `TIMETABLE_ENTRY_ACTIVATED`, `TIMETABLE_ENTRY_DEACTIVATED`, `CLASS_SCHEDULED`, and `CLASS_SCHEDULE_STATUS_UPDATED`.
