...
The latest full repository comparison is recorded in
`DOCUMENTATION_SYNC_AUDIT_2026-09-12.md`. Repository code and migrations override
older `PLANNED`, `NOT_STARTED`, or replacement-package status text.
