...
Latest repository synchronization: `DOCUMENTATION_SYNC_AUDIT_2026-09-12.md`.
Use that audit together with `CURRENT_IMPLEMENTATION_STATE.md` and
`PAGE_IMPLEMENTATION_REGISTRY.md` when determining what is actually implemented.
