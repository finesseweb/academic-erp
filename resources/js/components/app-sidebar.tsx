        ...
        ? [
              ...
              },
              {
                  ...
                  children: [
                      ...
                      {
                          title: 'Batches',
                          href: `/college/${collegeId}/batches`,
                          icon: Layers3,
                          permission: 'college_batch.view',
                      },
                      {
                          title: 'Sections',
                          href: `/college/${collegeId}/sections`,
                          icon: Rows3,
                          permission: 'college_section.view',
                      },
                      {
                          title: 'Academic Calendar',
                          href: `/college/${collegeId}/academic-calendar`,
                          icon: CalendarRange,
                          permission: 'college_academic_calendar.view',
                      },
                  ],
              },
              {
                  ...
                  children: [
                      ...
                      {
                          title: 'Admission Confirmation / Approval',
                          href: `/college/${collegeId}/admission-confirmations`,
                          icon: ClipboardCheck,
                          permission: 'college_admission_confirmation.view',
                          directNavigation: true,
                      },
                  ],
              },
