...
{
    protected $fillable = ['fee_structure_id','fee_head_id','amount','due_date','is_mandatory','is_enrollment_clearance_required','installment_allowed','display_order','status','created_by','updated_by'];
    protected $casts = ['amount'=>'decimal:2','due_date'=>'date:Y-m-d','is_mandatory'=>'boolean','is_enrollment_clearance_required'=>'boolean','installment_allowed'=>'boolean'];
