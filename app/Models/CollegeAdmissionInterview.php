...
class CollegeAdmissionInterview extends Model {
 protected $fillable=['college_admission_application_id','college_admission_application_choice_id','college_admission_selection_rule_id','college_admission_interview_panel_id','slot_sequence','panel_name','scheduled_at','venue','status','final_raw_score','final_max_score','normalized_score','remarks','evaluated_at','created_by','updated_by'];
