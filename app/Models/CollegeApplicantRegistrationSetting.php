...
class CollegeApplicantRegistrationSetting extends Model {
 protected $fillable=['college_id','registration_enabled','email_verification_required','captcha_required','registration_number_format','registration_sequence_next','application_help_phone','application_help_email','application_help_text','updated_by'];
