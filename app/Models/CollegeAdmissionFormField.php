...
{
    protected $fillable = ['college_admission_form_step_id','college_admission_form_panel_id','field_key','label','field_type','system_purpose','student_data_policy','student_profile_key','placeholder','help_text','is_required','is_locked','display_order','validation_rules','visibility_rules','condition_match_mode','status'];
