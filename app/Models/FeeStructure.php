...
{
    protected $fillable = ['university_id','college_id','college_program_offering_id','program_template_id','academic_session_id','name','code','purpose','charge_basis','charge_period_no','college_applicability','currency','status','notes','created_by','updated_by'];
