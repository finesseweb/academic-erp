...
use App\Http\Controllers\AttendanceEligibilityController;
use App\Http\Controllers\InternalAssessmentController;
...
use App\Http\Controllers\CourseDeliveryScheduleController;
...
use App\Http\Controllers\FacultyAllocationController;
...
Route::middleware(['auth', 'active', 'verified'])->group(function () {
    ...
    Route::get('college/{college}/course-offerings', [CourseOfferingController::class, 'index'])->name('course-offerings.index');
    Route::post('college/{college}/course-offerings', [CourseOfferingController::class, 'store'])->name('course-offerings.store');
    Route::patch('college/{college}/course-offerings/{courseOffering}/status', [CourseOfferingController::class, 'status'])->name('course-offerings.status');
    Route::get('college/{college}/faculty-allocations', [FacultyAllocationController::class, 'index'])->name('faculty-allocations.index');
    Route::post('college/{college}/faculty-allocations', [FacultyAllocationController::class, 'store'])->name('faculty-allocations.store');
    Route::patch('college/{college}/faculty-allocations/{facultyAllocation}', [FacultyAllocationController::class, 'update'])->name('faculty-allocations.update');
    Route::patch('college/{college}/faculty-allocations/{facultyAllocation}/status', [FacultyAllocationController::class, 'status'])->name('faculty-allocations.status');
    Route::get('college/{college}/rooms', [CourseDeliveryScheduleController::class, 'rooms'])->name('college-rooms.index');
    Route::post('college/{college}/rooms', [CourseDeliveryScheduleController::class, 'saveRoom'])->name('college-rooms.store');
    Route::patch('college/{college}/rooms/{room}', [CourseDeliveryScheduleController::class, 'updateRoom'])->name('college-rooms.update');
    Route::get('college/{college}/timetables', [CourseDeliveryScheduleController::class, 'timetables'])->name('college-timetables.index');
    Route::post('college/{college}/timetables', [CourseDeliveryScheduleController::class, 'saveTimetable'])->name('college-timetables.store');
    Route::patch('college/{college}/timetables/{entry}', [CourseDeliveryScheduleController::class, 'updateTimetable'])->name('college-timetables.update');
    Route::patch('college/{college}/timetables/{entry}/status', [CourseDeliveryScheduleController::class, 'timetableStatus'])->name('college-timetables.status');
    Route::get('college/{college}/class-schedules', [CourseDeliveryScheduleController::class, 'classes'])->name('class-schedules.index');
    Route::post('college/{college}/class-schedules', [CourseDeliveryScheduleController::class, 'saveClass'])->name('class-schedules.store');
    Route::patch('college/{college}/class-schedules/{classSchedule}', [CourseDeliveryScheduleController::class, 'updateClass'])->name('class-schedules.update');
    Route::patch('college/{college}/class-schedules/{classSchedule}/status', [CourseDeliveryScheduleController::class, 'classStatus'])->name('class-schedules.status');
    Route::get('college/{college}/attendance', [AttendanceController::class, 'index'])->name('attendance.index');
    Route::get('college/{college}/attendance/classes/{classSchedule}', [AttendanceController::class, 'edit'])->name('attendance.edit');
    Route::put('college/{college}/attendance/classes/{classSchedule}', [AttendanceController::class, 'save'])->name('attendance.save');
    Route::post('college/{college}/attendance/registers/{attendanceRegister}/reopen', [AttendanceController::class, 'reopen'])->name('attendance.reopen');
    Route::get('college/{college}/attendance-eligibility', [AttendanceEligibilityController::class, 'index'])->name('attendance-eligibility.index');
    Route::post('college/{college}/attendance-eligibility/{studentEnrollment}/{courseOffering}/exceptions', [AttendanceEligibilityController::class, 'requestException'])->name('attendance-eligibility.exceptions.store');
    Route::patch('college/{college}/attendance-exceptions/{attendanceExceptionRequest}', [AttendanceEligibilityController::class, 'decide'])->name('attendance-exceptions.decide');
    Route::post('college/{college}/attendance-eligibility/{studentEnrollment}/{courseOffering}/finalize', [AttendanceEligibilityController::class, 'finalize'])->name('attendance-eligibility.finalize');
    Route::get('college/{college}/internal-assessment/setup', [InternalAssessmentController::class, 'setup'])->name('internal-assessment.setup');
    Route::get('college/{college}/internal-assessment/assignments', [InternalAssessmentController::class, 'assignments'])->name('internal-assessment.assignments');
    Route::get('college/{college}/internal-assessment/quizzes', [InternalAssessmentController::class, 'quizzes'])->name('internal-assessment.quizzes');
    Route::get('college/{college}/internal-assessment/mid-semesters', [InternalAssessmentController::class, 'midSemesters'])->name('internal-assessment.mid-semesters');
    Route::get('college/{college}/internal-assessment/practicals', [InternalAssessmentController::class, 'practicals'])->name('internal-assessment.practicals');
    Route::get('college/{college}/internal-assessment/marks', [InternalAssessmentController::class, 'marks'])->name('internal-assessment.marks');
    Route::post('college/{college}/internal-assessment/components', [InternalAssessmentController::class, 'storeComponent'])->name('internal-assessment.components.store');
    Route::put('college/{college}/internal-assessment/components/{component}', [InternalAssessmentController::class, 'updateComponent'])->name('internal-assessment.components.update');
    Route::patch('college/{college}/internal-assessment/components/{component}/status', [InternalAssessmentController::class, 'componentStatus'])->name('internal-assessment.components.status');
    Route::post('college/{college}/internal-assessment/{type}/activities', [InternalAssessmentController::class, 'storeActivity'])->name('internal-assessment.activities.store');
    Route::patch('college/{college}/internal-assessment/activities/{activity}/status', [InternalAssessmentController::class, 'activityStatus'])->name('internal-assessment.activities.status');
    Route::put('college/{college}/internal-assessment/activities/{activity}/marks', [InternalAssessmentController::class, 'saveMarks'])->name('internal-assessment.marks.save');
    ...
    Route::get('college/{college}/fee-clearance', [CollegeFeeClearanceController::class, 'index'])->name('college-fee-clearance.index');
    Route::get('college/{college}/student-enrollments', [CollegeStudentEnrollmentController::class, 'index'])->name('college-student-enrollments.index');
    Route::post('college/{college}/student-enrollments/{admission}', [CollegeStudentEnrollmentController::class, 'store'])->name('college-student-enrollments.store');
    Route::get('college/{college}/student-imports', [CollegeStudentImportController::class, 'index'])->name('college-student-imports.index');
    Route::get('college/{college}/student-imports/template', [CollegeStudentImportController::class, 'template'])->name('college-student-imports.template');
    ...
    Route::post('college/{college}/student-identities/placement/bulk', [CollegeStudentIdentityController::class, 'assignPlacement'])->name('college-student-identities.placement.bulk');
