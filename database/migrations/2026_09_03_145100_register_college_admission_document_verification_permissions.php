...
return new class extends Migration
{
    private array $permissions = [
        ['college_admission_document_verification.view', 'view', 'View Admission Document Verification', false],
        ['college_admission_document_verification.review', 'review', 'Review Admission application documents', true],
        ['college_admission_document_verification.finalize', 'finalize', 'Finalize Admission document verification status', true],
    ];
    ...
    public function up(): void
    {
        ...
        foreach ($this->permissions as [$code, $action, $description, $sensitive]) {
            DB::table('permissions')->updateOrInsert(['code' => $code], [
                'resource' => 'college_admission_document_verification',
                'action' => $action,
                'module' => 'Admission',
