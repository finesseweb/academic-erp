...
return new class extends Migration
{
    private array $permissions = [
        ['college_admission_confirmation.view', 'view', 'View Admission Confirmation / Approval', false],
        ['college_admission_confirmation.confirm', 'confirm', 'Confirm final Admission against an allocated seat', true],
        ['college_admission_confirmation.revoke', 'revoke', 'Revoke Admission Confirmation before Student Enrollment', true],
    ];
    ...
    public function up(): void
    {
        ...
        foreach ($this->permissions as [$code, $action, $description, $sensitive]) {
            DB::table('permissions')->updateOrInsert(['code' => $code], [
                'resource' => 'college_admission_confirmation',
                'action' => $action,
                'module' => 'Admission',
