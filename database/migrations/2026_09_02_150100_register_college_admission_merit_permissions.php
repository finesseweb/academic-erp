...
return new class extends Migration
{
    private array $permissions = [
        ['college_admission_merit.view', 'view', 'View Admission Merit / Roster Generation', false],
        ['college_admission_merit.generate', 'generate', 'Generate and lock Admission Merit / Roster', true],
    ];
    ...
    public function up(): void
    {
        ...
        foreach ($this->permissions as [$code, $action, $description, $sensitive]) {
            DB::table('permissions')->updateOrInsert(['code' => $code], [
                'resource' => 'college_admission_merit',
                'action' => $action,
                'module' => 'Admission',
