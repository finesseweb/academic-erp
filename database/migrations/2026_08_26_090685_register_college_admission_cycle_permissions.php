...
return new class extends Migration
{
    private array $permissions = [
        ['college_admission_cycle.view', 'view', 'View Admission Cycles', false],
        ['college_admission_cycle.create', 'create', 'Create Admission Cycles', false],
        ['college_admission_cycle.update', 'update', 'Update Admission Cycles', false],
        ['college_admission_cycle.enable', 'enable', 'Activate Admission Cycles', true],
        ['college_admission_cycle.disable', 'disable', 'Deactivate or close Admission Cycles', true],
    ];
    ...
    public function up(): void
    {
        ...
        foreach ($this->permissions as [$code, $action, $description, $sensitive]) {
            DB::table('permissions')->updateOrInsert(['code' => $code], [
                'resource' => 'college_admission_cycle',
                'action' => $action,
                'module' => 'Admission',
